...
Реализация **Test-And-TAS** (TA-TAS) спинлока — оптимизированного варианта классического **TAS** (Test-And-Set)
спинлока.
...
![Message Passing via Atomics](../../assets/message-passing-via-atomics.png)
...
Именно это и обеспечивает **видимость**: чтения в критической секции наблюдают **последнюю** предшествующую в 
**happens-before** запись.
...
Таким образом, из [иерархии гарантий](../../README.md#19-слабые-модели-памяти):
