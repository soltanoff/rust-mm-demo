...
> [SPSCRingBuffer](../spscringbuffer/README.md), где подробно обосновываются memory orders.
> Здесь описывается только суть оптимизации, memory orders используются те же.

## Проблема: cache line bouncing в `SPSCRingBuffer`
...
Memory orders идентичны `SPSCRingBuffer` (обоснование см. в [README для SPSCRingBuffer](../spscringbuffer/README.md)).
